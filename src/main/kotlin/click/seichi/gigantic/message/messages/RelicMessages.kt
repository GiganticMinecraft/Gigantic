...
object RelicMessages {
    ...
    val NIGHTINGALE_FEATHER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "高さが普通"))
    val OBOROZUKI_SWORD_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "満月"))
    val SAKURA_RACE_CAKE_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "普通の森"))
    val CERTIFICATE_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "普通の砂浜"))
    val SCHOOL_BAG_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "日中"))
    val KATSUO_SASHIMI_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "暖かい海"))
