...
object RelicMessages {
    ...
    val ALSTROMERIA_SEED = LocalizedText(Locale.JAPANESE to "アルストロメリアの種")
    val NIGHTINGALE_FEATHER = LocalizedText(Locale.JAPANESE to "鶯の尾羽")
    val OBOROZUKI_SWORD = LocalizedText(Locale.JAPANESE to "朧月刀")
    val SAKURA_RACE_CAKE = LocalizedText(Locale.JAPANESE to "桜餅")
    val CERTIFICATE = LocalizedText(Locale.JAPANESE to "卒業証書")
    val SCHOOL_BAG = LocalizedText(Locale.JAPANESE to "ランドセル")
    val KATSUO_SASHIMI = LocalizedText(Locale.JAPANESE to "初鰹の刺身")
    ...
    val MORNING_GLORY_LEAVES = LocalizedText(Locale.JAPANESE to "朝顔の種子")
    val FUJI_ROUND_FUN = LocalizedText(Locale.JAPANESE to "富士柄の団扇")
    val HITSUMABUSHI = LocalizedText(Locale.JAPANESE to "ひつまぶし")
    val MOSQUITO_COIL = LocalizedText(Locale.JAPANESE to "蚊取り線香")
    val GOLD_FISH = LocalizedText(Locale.JAPANESE to "金魚")
    val WIND_BELL = LocalizedText(Locale.JAPANESE to "風鈴")
    val FIREFLY = LocalizedText(Locale.JAPANESE to "蛍")
    val STRAW_HAT = LocalizedText(Locale.JAPANESE to "麦わら帽子")
    val TERU_TERU = LocalizedText(Locale.JAPANESE to "てるてる坊主")
    val YUKATA = LocalizedText(Locale.JAPANESE to "綺麗な浴衣")
    val MARBLING_MEAT = LocalizedText(Locale.JAPANESE to "霜降り肉")
    val SHIRANUI = LocalizedText(Locale.JAPANESE to "不知火")
    val MOMIJI = LocalizedText(Locale.JAPANESE to "紅葉")
    val TOUROU = LocalizedText(Locale.JAPANESE to "燈籠")
    val SCARECROW = LocalizedText(Locale.JAPANESE to "案山子")
    val TSUKIMI_UDON = LocalizedText(Locale.JAPANESE to "月見うどん")
    val CHRYSANTHEMUM_DOLL = LocalizedText(Locale.JAPANESE to "菊人形")
    val SHRIKE_FEATHER = LocalizedText(Locale.JAPANESE to "百舌の羽根")
    val PERSIMMON_SEED = LocalizedText(Locale.JAPANESE to "柿の種")
    val SANMA = LocalizedText(Locale.JAPANESE to "秋刀魚")
    val KOTATSU = LocalizedText(Locale.JAPANESE to "炬燵")
    val CLAWS = LocalizedText(Locale.JAPANESE to "蟹の鋏")
    val ORANGE_PEEL = LocalizedText(Locale.JAPANESE to "蜜柑の皮")
    val ODEN = LocalizedText(Locale.JAPANESE to "おでん")
    val CRANE_FEATHER = LocalizedText(Locale.JAPANESE to "鶴の羽根")
    val HORNED_OWL_HORN = LocalizedText(Locale.JAPANESE to "ミミズクの耳")
    val GROUPER = LocalizedText(Locale.JAPANESE to "ハタハタ")
    val PUFFER_FISH = LocalizedText(Locale.JAPANESE to "フグ")
    val OYSTER = LocalizedText(Locale.JAPANESE to "牡蠣")
    val ANGLERFISH_LIPS = LocalizedText(Locale.JAPANESE to "アンコウの唇")
    ...
    val CACAO_WATERMELON_LORE = listOf(LocalizedText(Locale.JAPANESE to "カカオとスイカが混ざっている"), LocalizedText(Locale.JAPANESE to "美味しいのかよくわからない"))
    val RUSTED_COMPASS_LORE = listOf(LocalizedText(Locale.JAPANESE to "かろうじて原型を留めている羅針盤"), LocalizedText(Locale.JAPANESE to "針は動かない"))
    val USED_COIN_LORE = listOf(LocalizedText(Locale.JAPANESE to "どこかの国で使われていただろう金貨"))
    ...
    val BROKEN_BOW_LORE = listOf(LocalizedText(Locale.JAPANESE to "今にも折れそうな弓"), LocalizedText(Locale.JAPANESE to "見た事のない素材が弦として使われている"), LocalizedText(Locale.JAPANESE to "原住民の遺物"))
    val BIRCH_MUSHROOM_LORE = listOf(LocalizedText(Locale.JAPANESE to "キノコ、のこのこ、元気の子"))
    val ADVENTURER_SOLE_LORE = listOf(LocalizedText(Locale.JAPANESE to "かつてここを通った冒険家の靴底"), LocalizedText(Locale.JAPANESE to "さぞ歩きにくかったに違いない"))
    ...
    val BEAST_BONE_LORE = listOf(LocalizedText(Locale.JAPANESE to "トラのような骨"), LocalizedText(Locale.JAPANESE to "狩りをしたときの取り残しだろうか"))
    val THIN_TOOTH_LORE = listOf(LocalizedText(Locale.JAPANESE to "大きくて鋭い歯"), LocalizedText(Locale.JAPANESE to "先が割れてしまっている"))
    ...
    val HORN_LORE = listOf(LocalizedText(Locale.JAPANESE to "動物の角でできたよくある笛"), LocalizedText(Locale.JAPANESE to "いい音色が出そう"))
    val BROKEN_FORCE_FLAG_LORE = listOf(LocalizedText(Locale.JAPANESE to "持ち手に少し傷がつき、"), LocalizedText(Locale.JAPANESE to "布も虫に食われている"))
    val SYLPH_LEAFE_LORE = listOf(LocalizedText(Locale.JAPANESE to "風の精霊が落とした葉っぱ"), LocalizedText(Locale.JAPANESE to "魔力が込められている"))
    val BROKEN_TRAP_LORE = listOf(LocalizedText(Locale.JAPANESE to "昔の遺跡に仕掛けられたものだろうか"), LocalizedText(Locale.JAPANESE to "トラバサミによく似ている"))
    val RAINBOW_CLAY_LORE = listOf(LocalizedText(Locale.JAPANESE to "長い年月をかけ虹色になった"))
    val SHADE_ARMOR_LORE = listOf(LocalizedText(Locale.JAPANESE to "闇の精の装備品"), LocalizedText(Locale.JAPANESE to "見るだけで震えが止まらない…"))
    val CLAY_IMAGE_LORE = listOf(LocalizedText(Locale.JAPANESE to "上質な堅焼き粘土で出来ている"))
    val BIG_FUNG_LORE = listOf(LocalizedText(Locale.JAPANESE to "キバの持ち主は"), LocalizedText(Locale.JAPANESE to "想像がつかないほど大きいだろう"))
    ...
    val BUDDHIST_STATUE_LORE = listOf(LocalizedText(Locale.JAPANESE to "古い仏像らしい"), LocalizedText(Locale.JAPANESE to "もうとっくに錆びている"), LocalizedText(Locale.JAPANESE to "あとで供養をしてあげよう"))
    val BROKEN_LEAD_LORE = listOf(LocalizedText(Locale.JAPANESE to "壊れたリード"), LocalizedText(Locale.JAPANESE to "散歩の途中にでも切れたのだろうか"))
    val EGGPLANT_LORE = listOf(LocalizedText(Locale.JAPANESE to "ナス科ナス属の植物またその果実"), LocalizedText(Locale.JAPANESE to "ただの茄子"))
    val OLD_AXE_LORE = listOf(LocalizedText(Locale.JAPANESE to "刃が欠けていて"), LocalizedText(Locale.JAPANESE to "もう使用することはできない。"))
    val CRYSTAL_OF_SNOW_LORE = listOf(LocalizedText(Locale.JAPANESE to "雪の結晶"))
    val FROSTED_FISH_LORE = listOf(LocalizedText(Locale.JAPANESE to "大きい魚が小さい魚に"), LocalizedText(Locale.JAPANESE to "喰らい付いたまま凍っている", Locale.JAPANESE to "とても芸術的"))
    val VODKA_BOTTLE_LORE = listOf(LocalizedText(Locale.JAPANESE to "北の国から流れてきた空き瓶"))
    val SAIL_LORE = listOf(LocalizedText(Locale.JAPANESE to "大航海時代"), LocalizedText(Locale.JAPANESE to "商船の帆の切れ端"), LocalizedText(Locale.JAPANESE to "少し胡椒の匂いがする"))
    val TREASURE_CASKET_LORE = listOf(LocalizedText(Locale.JAPANESE to "これであなたもおじいちゃんに…？"))
    val DEEP_SEA_FISH_DIODE_LORE = listOf(LocalizedText(Locale.JAPANESE to "深海魚の頭部に生えた発光器のようだ"), LocalizedText(Locale.JAPANESE to "これで餌を集めているのであろう"))
    val SEICHI_MACKEREL_LORE = listOf(LocalizedText(Locale.JAPANESE to "鯖"), LocalizedText(Locale.JAPANESE to "それ以外の何者でもない"))
    val NOT_MELTTED_ICE_LORE = listOf(LocalizedText(Locale.JAPANESE to "とても冷たい"), LocalizedText(Locale.JAPANESE to "持っているだけで凍りつきそうだ。"))
    val WHITE_FLOWER_LORE = listOf(LocalizedText(Locale.JAPANESE to "雪のように白い"))
    val FROSTED_ORE_LORE = listOf(LocalizedText(Locale.JAPANESE to "貴重なダイヤモンドが凍り"), LocalizedText(Locale.JAPANESE to "氷の中できらめいている。"))
    val MAMMMOTH_RAW_MEET_LORE = listOf(LocalizedText(Locale.JAPANESE to "凍った伝説のﾏｿﾓｽのお肉"), LocalizedText(Locale.JAPANESE to "なんだかとってもおいしそう"))
    val TENT_CLOTH_LORE = listOf(LocalizedText(Locale.JAPANESE to "既に放棄された拠点のようだ"), LocalizedText(Locale.JAPANESE to "布は霜に覆われている"))
    val CAMP_FIRE_TRACE_LORE = listOf(LocalizedText(Locale.JAPANESE to "既に放棄された拠点のようだ"), LocalizedText(Locale.JAPANESE to "炭は乾かせばまだ使えそうにも見える"))
    val FROSTED_PINECONE_LORE = listOf(LocalizedText(Locale.JAPANESE to "松ぼっくりに白い霜が付いている"), LocalizedText(Locale.JAPANESE to "太陽にかざすとキラキラして綺麗だ"))
    val FROSTED_CRAFTBOX_LORE = listOf(LocalizedText(Locale.JAPANESE to "とあるクラフターが使ったと言われる作業台"), LocalizedText(Locale.JAPANESE to "ver1.3と刻印されている"))
    val MUSH_FISH_LORE = listOf(LocalizedText(Locale.JAPANESE to "キノコ島の菌にやられた魚"), LocalizedText(Locale.JAPANESE to "見た目と裏腹にかなり美味しい"))
    val MYCELIUM_PICKAXE_LORE = listOf(LocalizedText(Locale.JAPANESE to "整地しようとしたが"), LocalizedText(Locale.JAPANESE to "菌糸に飲まれたらしい"))
    val ACID_GEAR_LORE = listOf(LocalizedText(Locale.JAPANESE to "どこかにたくさんのゴーレムが"), LocalizedText(Locale.JAPANESE to "隠されているらしい"))
    ...
    val ORICHALCUM_LORE = listOf(LocalizedText(Locale.JAPANESE to "とても珍しい鉱石"), LocalizedText(Locale.JAPANESE to "まだ見つけられたことはないらしい"))
    val BEAUTIFUL_ORE_LORE = listOf(LocalizedText(Locale.JAPANESE to "琥珀色の鉱石"))
    val BANANA_SKIN_LORE = listOf(LocalizedText(Locale.JAPANESE to "ジャングルの動物達に"), LocalizedText(Locale.JAPANESE to "人気な果実である"))
    val INSECT_HORN_LORE = listOf(LocalizedText(Locale.JAPANESE to "黒光りしている"))
    val ICICLE_LORE = listOf(LocalizedText(Locale.JAPANESE to "不思議な色をしていて"), LocalizedText(Locale.JAPANESE to "太陽に照らすと神秘的な光を放つ"))
    val FROSTED_WHEEL_LORE = listOf(LocalizedText(Locale.JAPANESE to "馬車の車輪だろうか"), LocalizedText(Locale.JAPANESE to "細かい彫刻がある"))
    val DARK_MATTER_LORE = listOf(LocalizedText(Locale.JAPANESE to "暗黒物質"), LocalizedText(Locale.JAPANESE to "手に入れた者には不幸が訪れるという"))
    ...
    val CRAMPONS_LORE = listOf(LocalizedText(Locale.JAPANESE to "まだ新しい"), LocalizedText(Locale.JAPANESE to "雪山もしっかり登れそうだ"))
    val SLICED_ROPE_LORE = listOf(LocalizedText(Locale.JAPANESE to "巨木に登ろうとしたのだろうか"), LocalizedText(Locale.JAPANESE to "無残にもちぎれている"))
    val BLACK_CLOTH_LORE = listOf(LocalizedText(Locale.JAPANESE to "何やら怪しいオーラの漂う布"))
    val LIGHTNING_MOSS_LORE = listOf(LocalizedText(Locale.JAPANESE to "その苔は光も受けずに"), LocalizedText(Locale.JAPANESE to "不気味に輝いていた"))
    val BROWN_SAP_LORE = listOf(LocalizedText(Locale.JAPANESE to "透き通ったきれいな樹液"), LocalizedText(Locale.JAPANESE to "蟻がたかっている"))
    val BLOODSTAINED_SWORD_LORE = listOf(LocalizedText(Locale.JAPANESE to "時間が経ち真っ黒になった血が"), LocalizedText(Locale.JAPANESE to "べっとりとこびりついている"))
    val WEB_SCRAP_LORE = listOf(LocalizedText(Locale.JAPANESE to "漁業で使われる大きな網の切れ端"))
    val DOWN_TREE_LORE = listOf(LocalizedText(Locale.JAPANESE to "虫に食われたような穴があるが"), LocalizedText(Locale.JAPANESE to "まだ腐ってはいない"))
    val CARNIVORE_BONE_LORE = listOf(LocalizedText(Locale.JAPANESE to "大きな頭の骨"), LocalizedText(Locale.JAPANESE to "きっと食物連鎖の頂点だったに違いない"))
    ...
    val PRICKLE_LORE = listOf(LocalizedText(Locale.JAPANESE to "木のトゲ"), LocalizedText(Locale.JAPANESE to "小さいがよく尖っている"))
    val WOOD_SLAB_LORE = listOf(LocalizedText(Locale.JAPANESE to "ボートに使ったものらしい"), LocalizedText(Locale.JAPANESE to "乗っていた人は無事だろうか"))
    val BROKEN_WATERMELON_LORE = listOf(LocalizedText(Locale.JAPANESE to "太古の昔誰かが割ったスイカの化石"))
    val RLYEH_TEXT_LORE = listOf(LocalizedText(Locale.JAPANESE to "人の皮で装丁されている"), LocalizedText(Locale.JAPANESE to "読まないほうがよさそうだ"))
    val CUTE_WATERING_POT_LORE = listOf(LocalizedText(Locale.JAPANESE to "使っていた人は"), LocalizedText(Locale.JAPANESE to "さぞ大事にしていたことだろう"))
    ...
    val ALSTROMERIA_SEED_LORE = listOf(LocalizedText(Locale.JAPANESE to "花持ちがいいらしい"))
    val NIGHTINGALE_FEATHER_LORE = listOf(LocalizedText(Locale.JAPANESE to "春を告げる鳥の小さな羽"))
    val OBOROZUKI_SWORD_LORE = listOf(LocalizedText(Locale.JAPANESE to "水蒸気のベールがかかったように見える"))
    val SAKURA_RACE_CAKE_LORE = listOf(LocalizedText(Locale.JAPANESE to "ピンク色の餅"), LocalizedText(Locale.JAPANESE to "桜の葉が入っているようだ"))
    val CERTIFICATE_LORE = listOf(LocalizedText(Locale.JAPANESE to "箱は汚れているが、保存状態は良好である"))
    val SCHOOL_BAG_LORE = listOf(LocalizedText(Locale.JAPANESE to "子供用のバッグらしい"), LocalizedText(Locale.JAPANESE to "何故か懐かしく感じる"))
    val KATSUO_SASHIMI_LORE = listOf(LocalizedText(Locale.JAPANESE to "脂が少なくさっぱりしている"))
    ...
    val MORNING_GLORY_LEAVES_LORE = listOf(LocalizedText(Locale.JAPANESE to "煮ても焼いても食べられない"), LocalizedText(Locale.JAPANESE to "毒性の種子"))
    val FUJI_ROUND_FUN_LORE = listOf(LocalizedText(Locale.JAPANESE to "立派な富士山が描かれている"))
    val HITSUMABUSHI_LORE = listOf(LocalizedText(Locale.JAPANESE to "名古屋めしとも呼ばれるらしい"))
    val MOSQUITO_COIL_LORE = listOf(LocalizedText(Locale.JAPANESE to "ぐるぐると巻かれている"))
    val GOLD_FISH_LORE = listOf(LocalizedText(Locale.JAPANESE to "黄金に輝いている"))
    val WIND_BELL_LORE = listOf(LocalizedText(Locale.JAPANESE to "ちりんちりん、と心地よい音がなる"))
    val FIREFLY_LORE = listOf(LocalizedText(Locale.JAPANESE to "蛍の光 窓の雪"))
    val STRAW_HAT_LORE = listOf(LocalizedText(Locale.JAPANESE to "赤いリボンが巻いてある"))
    val TERU_TERU_LORE = listOf(LocalizedText(Locale.JAPANESE to "白くて可愛らしい人形"))
    val YUKATA_LORE = listOf(LocalizedText(Locale.JAPANESE to "花柄の浴衣"))
    val MARBLING_MEAT_LORE = listOf(LocalizedText(Locale.JAPANESE to "まつざかぎゅうではなく、"), LocalizedText(Locale.JAPANESE to "まつさかうしというらしい"))
    val SHIRANUI_LORE = listOf(LocalizedText(Locale.JAPANESE to "龍神の灯火という異名をもつ"))
    val MOMIJI_LORE = listOf(LocalizedText(Locale.JAPANESE to "赤や黄色や橙の葉がある"))
    val TOUROU_LORE = listOf(LocalizedText(Locale.JAPANESE to "淡く燃える炎は儚く、美しい"))
    val SCARECROW_LORE = listOf(LocalizedText(Locale.JAPANESE to "とても臭い魚の頭が付いている"))
    val TSUKIMI_UDON_LORE = listOf(LocalizedText(Locale.JAPANESE to "黄身を満月、白身を雲、"), LocalizedText(Locale.JAPANESE to "海苔を夜空に見立てている"))
    val CHRYSANTHEMUM_DOLL_LORE = listOf(LocalizedText(Locale.JAPANESE to "ちょっと怖い。菊のいい匂いがする"))
    val SHRIKE_FEATHER_LORE = listOf(LocalizedText(Locale.JAPANESE to "百の鳥の鳴き声を真似る鳥"))
    val PERSIMMON_SEED_LORE = listOf(LocalizedText(Locale.JAPANESE to "ピーナッツがない、"), LocalizedText(Locale.JAPANESE to "ピーナッツが好きなのに"))
    val SANMA_LORE = listOf(LocalizedText(Locale.JAPANESE to "国民的お笑いスター"))
    val KOTATSU_LORE = listOf(LocalizedText(Locale.JAPANESE to "一度飲み込まれると、抜け出せない"))
    val CLAWS_LORE = listOf(LocalizedText(Locale.JAPANESE to "左より右のほうが大きく、力強い"))
    val ORANGE_PEEL_LORE = listOf(LocalizedText(Locale.JAPANESE to "天日干しにしてお風呂に入れたい"))
    val ODEN_LORE = listOf(LocalizedText(Locale.JAPANESE to "おでんのでんは田楽のでん"))
    val CRANE_FEATHER_LORE = listOf(LocalizedText(Locale.JAPANESE to "真っ白いきれいな羽根"))
    val HORNED_OWL_HORN_LORE = listOf(LocalizedText(Locale.JAPANESE to "耳のような突き出た羽根"))
    val GROUPER_LORE = listOf(LocalizedText(Locale.JAPANESE to "深海に潜む。ブリコが美味しい"))
    val PUFFER_FISH_LORE = listOf(LocalizedText(Locale.JAPANESE to "大体毒があり食べれないが美味"))
    val OYSTER_LORE = listOf(LocalizedText(Locale.JAPANESE to "太古の昔から生き永らえてきた"))
    val ANGLERFISH_LIPS_LORE = listOf(LocalizedText(Locale.JAPANESE to "アンコウは唇ばかり残るなり"))
    ...
    val ALSTROMERIA_SEED_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "土ブロック"))
    val NIGHTINGALE_FEATHER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "高度が普通かつ温帯"))
    val OBOROZUKI_SWORD_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "三日月"))
    val SAKURA_RACE_CAKE_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "普通の森または白樺の森"))
    val CERTIFICATE_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "普通の砂浜かつ砂ブロック"))
    val SCHOOL_BAG_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "日中"))
    ...
    val MORNING_GLORY_LEAVES_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "夜明け"))
    val FUJI_ROUND_FUN_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "高度が高いかつ普通の山"))
    val HITSUMABUSHI_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "丑の刻"))
    val MOSQUITO_COIL_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "居待月"))
    val GOLD_FISH_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "海洋かつ金鉱石"))
    val WIND_BELL_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "申の刻"))
    val FIREFLY_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "夜間"))
    val STRAW_HAT_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "荒野台地または普通の荒野"))
    val TERU_TERU_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "十三夜"))
    val YUKATA_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "黄昏"))
    val MARBLING_MEAT_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "寒いかつ上弦の月"))
    val SHIRANUI_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "子の刻"))
    val MOMIJI_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "森のある山または二十六夜"))
    val TOUROU_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "閃緑岩"))
    val SCARECROW_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "安山岩"))
    val TSUKIMI_UDON_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "満月"))
    val CHRYSANTHEMUM_DOLL_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "下弦の月"))
    val SHRIKE_FEATHER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "酉の刻"))
    val PERSIMMON_SEED_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "砂利"))
    val SANMA_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "海または冷たい海"))
    val KOTATSU_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "マグマブロック"))
    val CLAWS_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "砂"))
    val ORANGE_PEEL_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "巳の刻"))
    val ODEN_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "新月"))
    val CRANE_FEATHER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "卯の刻"))
    val HORNED_OWL_HORN_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "薄暗い森かつ夜明け"))
    val GROUPER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "深海または冷たい深海"))
    val PUFFER_FISH_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "ポドゾル"))
    val OYSTER_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "焼き石"))
    val ANGLERFISH_LIPS_BONUS_LORE = listOf(LocalizedText(Locale.JAPANESE to "寅の刻"))
}