...
object DatabaseLang {
    ...
    val PROFILE_LOADING_MESSAGE = Message(MessageProtocol.TITLE, LocalizedString(
            Locale.JAPANESE to "${ChatColor.BLUE}${ChatColor.BOLD}読み込み中...",
            Locale.ENGLISH to "${ChatColor.BLUE}${ChatColor.BOLD}Loading..."
    ))

    val PROFILE_LOAD_COMPLETED_MESSAGE = Message(MessageProtocol.TITLE, LocalizedString(
