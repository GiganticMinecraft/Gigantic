...
object RelicMenu : Menu() {
    ...
    object NaturaRelicMenu : WillRelicMenu(Will.NATURA, 6 * 9) {
        init {
            ...
            registerButton(4, RelicButtons.WILL_RELIC(WillRelic.SUMMER_DAY))
            ...
            registerButton(21, RelicButtons.WILL_RELIC(WillRelic.FROSTED_PINECONE))
    ...
    object GlaciesRelicMenu : WillRelicMenu(Will.GLACIES, 6 * 9) {
        init {
            ...
            registerButton(28, RelicButtons.WILL_RELIC(WillRelic.SNOW_AMBER))
