...
enum class Boss(
    ...
    THE_EARTH(
            ...
            100000000,
            10,
            DropRelic(Relic.EARTH_CORE, 0.4)
    ),
    STEEL(
            4,
            Head.STEEL,
            ...
            10000,
            10,
            DropRelic(Relic.STEEL_INGOT, 0.8)
    ),
    BIRD(
            5,
            Head.BIRD,
    ...
    TURKEY(
            ...
            100,
            3,
            DropRelic(Relic.GRILLED_TURKEY, 0.6)
    ),
    PINK_MUSHROOM(
            8,
            Head.PINK_MUSHROOM,
            ...
            130,
            7,
            DropRelic(Relic.PINK_SPORES, 0.9)
    ),
    RAINBOW(
            9,
            Head.RAINBOW,
            ...
            12345,
            2,
            DropRelic(Relic.A_PIECE_OF_RAINBOW, 0.28)
    ),
    MERMAID(
            10,
            Head.MERMAID,
            ...
            80000,
            6,
            DropRelic(Relic.MERMAID_TEARS, 0.33)
    ),
    MERMAN(
            11,
            Head.MERMAN,
            ...
            140000,
            8,
            DropRelic(Relic.MERMAN_SCALES, 0.88)
    ),
    TRITON(
            12,
            Head.TRITON,
            ...
            100000000,
            10,
            DropRelic(Relic.TRITON_TRIDENT, 0.42)
    ),
    BISMARCK(
            13,
            Head.BISMARCK,
            ...
            1000,
            11,
            DropRelic(Relic.BISMARCK_IRON_KNUCKLE, 0.75)
    ),
    STONE(
            14,
            Head.STONE,
            ...
            80,
            4,
            DropRelic(Relic.COBBLE_STONE, 0.3)
    ),
    MOTHER(
            15,
            Head.MOTHER,
            ...
            1,
            30,
            DropRelic(Relic.LOVE_OF_MOTHER, 1.00)
    ),
