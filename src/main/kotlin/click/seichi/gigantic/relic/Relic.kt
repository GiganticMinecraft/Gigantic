...
enum class Relic(
    ...
    TURTLE_KING_CROWN(6, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
    SPIDER_KING_CROWN(7, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
    ZOMBIE_KING_CROWN(8, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
    SKELETON_KING_CROWN(9, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
    ORC_KING_CROWN(10, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
    GHOST_KING_CROWN(11, RelicMessages.CHICKEN_KING_CROWN, RelicMessages.CHICKEN_KING_CROWN_LORE, icon = Head.CHICKEN_KING_CROWN.toItemStack()),
