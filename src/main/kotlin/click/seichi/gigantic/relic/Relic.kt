...
enum class Relic(
    ...
    MERMAID_TEARS(1011, RelicRarity.RARE, RelicMessages.MERMAID_TEARS_NAME, RelicMessages.MERMAID_TEARS_DESCRIPTION),
    MERMAN_SCALES(1012, RelicRarity.NORMAL, RelicMessages.FISHERMAN_SCALES_NAME, RelicMessages.FISHERMAN_SCALES_DESCRIPTION),
    TRITON_TRIDENT(1013, RelicRarity.RARE, RelicMessages.TRITON_TRIDENT_NAME, RelicMessages.TRITON_TRIDENT_DESCRIPTION),
    BISMARCK_IRON_KNUCKLE(1014, RelicRarity.NORMAL, RelicMessages.BISMARCK_IRON_KNUCKLE_NAME, RelicMessages.BISMARCK_IRON_KNUCKLE_DESCRIPTION),
    COBBLE_STONE(1015, RelicRarity.RARE, RelicMessages.COBBLE_STONE_NAME, RelicMessages.COBBLE_STONE_DESCRIPTION),
    LOVE_OF_MOTHER(1016, RelicRarity.NORMAL, RelicMessages.LOVE_OF_MOTHER_NAME, RelicMessages.LOVE_OF_MOTHER_DESCRIPTION),
    ;
